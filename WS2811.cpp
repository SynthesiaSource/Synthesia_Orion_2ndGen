...
WS2811::WS2811(uint16_t n, uint8_t p, uint8_t t) {
  numBytes = n * 3;
...
boolean WS2811::isEnabled(void) {
  return enabled;
} // isEnabled()


boolean WS2811::isDisabled(void) {
  return !enabled;
} // isDisabled()
...
uint32_t WS2811::getPixelColor(uint16_t n) {
